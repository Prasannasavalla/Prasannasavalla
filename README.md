...
I transform raw data into actionable insights. I thrive on cleaning complex datasets, uncovering hidden patterns, and translating numbers into stories that drive smarter business decisions.  
...
![Stats](https://img.shields.io/badge/-Statistics-6F42C1?style=for-the-badge)

---

## 🔍 What I Do
- Clean, transform, and validate complex datasets using **Python, SQL, and Pandas**  
- Perform **Exploratory Data Analysis (EDA)** and statistical analysis to extract insights  
- Build **interactive dashboards** and visualizations using **Tableau & Power BI**  
- Develop **machine learning models** for prediction and trend analysis  
